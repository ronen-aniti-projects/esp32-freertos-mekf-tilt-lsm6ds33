...
plt.title(r"X-Axis Angular Rate Residual ($\omega_x - \bar{\omega}_x$)")
plt.xlabel(r"$\omega_x - \bar{\omega}_x$ [rad/s]")
plt.ylabel("count")

plt.subplot(3, 1, 2)
plt.hist(gy, bins=bins)
plt.title(r"Y-Axis Angular Rate Residual ($\omega_y - \bar{\omega}_y$)")
plt.xlabel(r"$\omega_y - \bar{\omega}_y$ [rad/s]")
plt.ylabel("count")
